...
player_health_rect = pygame.Rect(
    player_health_x, player_health_y, player_health_width, player_health_height)

player_health_rect_red = pygame.Rect(
    player_health_x, player_health_y, 54, player_health_height)
...
# Reload Timers
RELOAD_DELAY_TYPE1 = 600   # milliseconds
...
class Projectile():
    def __init__(self, start_pos: Coordinate, direction: float, speed: int, color: Color):
        self.size = (20, 20)
        self.direction = direction  # Angle `theta`
        self.speed = speed
        self.color = color
    ...
    def draw(self, display):
        pygame.draw.rect(display, (self.color.r, self.color.g,
                         self.color.b), self.hitbox)
        return self
...
while game_over == False:
        ...
        if pygame.mouse.get_pressed():
            ...
            if (now > last_shot + RELOAD_DELAY_TYPE1):
                ...
                projectile = Projectile(
                    (player_rect.center), angle, 3, projectile_color)
 ...
 #   if pygame.MOUSEBUTTONDOWN == True:
  #      bullet.draw_bullet(display)
    ...
    pygame.draw.rect(display, surrounding_color,
                     (surrounding1_x, surrounding1_y, 60, 60))
    pygame.draw.rect(display, surrounding_color,
                     (surrounding2_x, surrounding2_y, 70, 70))
    ...
    pygame.draw.line(display, wall_color, (left_wall_top_x,
                     left_wall_top_y), (left_wall_bottom_x, left_wall_bottom_y), 10)
    pygame.draw.line(display, wall_color, (top_wall_left_x,
                     top_wall_left_y), (top_wall_right_x, top_wall_right_y), 10)
    pygame.draw.line(display, wall_color, (right_wall_top_x,
                     right_wall_top_y), (right_wall_bottom_x, right_wall_bottom_y), 10)
    pygame.draw.line(display, wall_color, (bottom_wall_left_x,
                     bottom_wall_left_y), (bottom_wall_right_x, bottom_wall_right_y), 10)

    pygame.draw.line(display, (60, 60, 60), player_rect.center,
